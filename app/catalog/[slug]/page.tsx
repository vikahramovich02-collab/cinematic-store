        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
          ...
          <div className="space-y-2">
            ...
            <div
              ...
              style={{
                background: `linear-gradient(160deg, ${bg} 0%, #f0ede8 100%)`,
              }}
            >
              {product.badge && (
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-white/20 text-xs tracking-[0.3em] font-medium">
                  ФОТО СКОРО
                </span>
              </div>
            ...
            <div className="flex gap-2">
              {[0, 1].map((i) => (
                <button
                  ...
                  style={{
                    background: `linear-gradient(${i === 0 ? "160deg" : "340deg"}, ${bg} 0%, #f0ede8 100%)`,
                  }}
                />
              ))}
            </div>
          ...
          <div className="flex flex-col md:pt-4">
            <p className="text-[10px] tracking-[0.25em] text-gray-400 mb-1 font-medium">
              {product.collection}
            </p>
